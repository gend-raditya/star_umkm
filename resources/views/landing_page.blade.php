...
<section class="relative min-h-screen flex items-center justify-center pt-20 bg-center bg-cover"
        ...
        <div class="space-y-8">
            <div class="space-y-4">
                ...
                <p class="text-xl sm:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-light">
                    Temukan aneka oleh-oleh khas UMKM lokal mulai dari <span class="font-semibold text-yellow-300">camilan lezat</span> hingga <span class="font-semibold text-emerald-300">kerajinan tangan</span> unik yang otentik dan berkualitas
                </p>
            </div>

            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="#produk-terbaru" class="group relative px-8 py-4 bg-white/20 glass rounded-full text-white font-semibold text-lg hover:bg-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl border border-white/80">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                {{-- <div class="group relative bg-white/50 glass rounded-3xl p-8 text-center hover:bg-white/40 transition-all duration-300 transform hover:-translate-y-2 shadow-xl border border-white/30"> --}}
                    <div class="group relative bg-white/50 glass rounded-3xl p-8 text-center
            ...
            shadow-xl border border-white/20 ring-1 ring-white/40">
                    ...
                    <div class="mb-6">
                        <div class="w-20 h-20 bg-gradient-to-br from-orange-400 to-red-400 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <p class="text-[#767480] leading-relaxed">Serundeng dan makanan olahan berkualitas tinggi dari UMKM lokal terpercaya</p>
                    </div>
                    <div class="mt-6">
                        {{-- <span class="inline-flex items-center px-4 py-2 bg-white/10 rounded-full text-white/90 text-sm font-medium"> --}}
                            <span class="inline-flex items-center px-4 py-2 bg-[#7FA9B0] rounded-full text-white text-sm font-medium">
                            Lihat Produk
            ...
            shadow-xl border border-white/20 ring-1 ring-white/40">
                    ...
                    <div class="mb-6">
                        <div class="w-20 h-20 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <p class="text-[#767480] leading-relaxed">Minuman segar dan tradisional pilihan dari berbagai daerah Indonesia</p>
                    </div>
                    <div class="mt-6">
                        <span class="inline-flex items-center px-4 py-2 bg-[#7FA9B0] rounded-full text-white text-sm font-medium">
                            Lihat Produk
            ...
            shadow-xl border border-white/20 ring-1 ring-white/40">
                    ...
                    <div class="mb-6">
                        <div class="w-20 h-20 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                            <img src="{{ asset('images/icons/ikon-kerajinan.png') }}" alt="Ikon Kerajinan" class="w-12 h-12">
                        </div>
                        <h3 class="text-2xl font-bold text-[#7FA9B0] mb-3">Kerajinan</h3>
                        <p class="text-[#767480] leading-relaxed">Tas anyaman dan kerajinan tangan unik dengan sentuhan budaya lokal</p>
                    </div>
                    <div class="mt-6">
                        <span class="inline-flex items-center px-4 py-2 bg-[#7FA9B0] rounded-full text-white text-sm font-medium">
                            Lihat Produk
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-xl text-[#767480] max-w-3xl mx-auto leading-relaxed">
                    Setiap produk UMKM memiliki cerita — rasakan cita rasa, kualitas, dan keunikan karya anak bangsa di sini. Pilihan makanan, minuman, dan kerajinan lokal berkualitas yang siap mendukung gaya hidup Anda setiap hari
                </p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                @forelse($produkTerbaru as $produk)
                    {{-- <div class="group relative bg-white/10 glass rounded-2xl overflow-hidden hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl"> --}}
                    <div class="group relative bg-white/60 glass rounded-2xl overflow-hidden hover:bg-emerald transition-all duration-300 transform hover:-translate-y-2 shadow-xl border-2 border-[rgba(167,196,188,0.95)]">
                        ...
                        <div class="p-6">
                            <div class="mb-2">
                                <span class="text-emerald-400 text-sm font-medium uppercase tracking-wider">Premium Collection</span>
                            </div>
    ...
    <section class="mb-28 mt-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-[rgba(167,196,188,0.95)]/40 glass rounded-3xl p-8 lg:p-12 text-center border-2 border-[rgba(167,196,188,0.95)]">
                <div class="max-w-2xl mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
                        ...
                        <button class="px-8 py-4 bg-gradient-to-r from-[#7BB8A7] to-[#7BB8A7] text-white rounded-2xl font-semibold hover:from-[#67B29D] hover:to-[#67B29D] transition-all duration-300 transform hover:scale-105 shadow-lg">
                            Subscribe
                        </button>
                    </div>
    ...
    <button id="scrollToTop" class="fixed bottom-8 right-8 w-12 h-12 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-lg opacity-0 invisible transition-all duration-300 transform hover:scale-110 z-40">
